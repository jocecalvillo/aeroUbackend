...
const PrecioCombustible = require('../models/precioCombustibleHist');
...
const getPrecio = async (req, res = response) => {
    ...
    const [precios, total] = await Promise.all([
        PrecioCombustible
            .find({}, 'match combustible dia vigenciaInicio vigenciaFin aeropuerto nombreAeropuerto precioConDescuento precioSinDescuento precioGalMex precioDolar usuario')
            .skip(desde)
            .limit(10000000),
